...
class Player(char.Character):
    def __init__(self, pos, player_info, scale, last_update, tile_size, current_anim):#last_update is temporary
        super().__init__(pos, player_info, scale, last_update, tile_size, current_anim)
