...
class Projectile():
    def __init__(self, proj_pos, proj_type, proj_area, damage, speed, life_time, spawn_time, player_pos, center=None):
        self.x, self.y = proj_pos[0], proj_pos[1]
        self.proj_type = proj_type
        self.proj_area = proj_area
        #self.proj_surface = pg.Surface((proj_area, proj_area))
        self.damage = damage
        self.speed = speed
        self.life_time = life_time
        self.spawn_time = spawn_time

        self.playerx, self.playery = player_pos[0], player_pos[1]#REMPLACE CETTE MERDE PAR CENTER
